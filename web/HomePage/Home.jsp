...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="table-container">
                        <table class="product-table">
                            ...
                            <tbody>
                                ...
                                %>
                                <tr class="table-row">
                                    <td class="table-cell"><img src="<%= product.getImage()%>" alt="<%= product.getProductName()%>"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-actions">
                        <button class="action-button" id="edit-button">Sửa</button>
        ...
        <script>
            function openModal(productCode, productName, productPrice, productQuantity, productLocation, productDescription, productImage) {
                document.getElementById("modal-product-code").textContent = productCode;
                document.getElementById("modal-product-name").textContent = productName;
                document.getElementById("modal-product-price").textContent = productPrice;
                document.getElementById("modal-product-quantity").textContent = productQuantity;
