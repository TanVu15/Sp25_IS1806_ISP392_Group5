            ...
            <div class="body-container">
                ...
                <div class="homepage-body">
                            ...
                            <table class="product-table">
                                ...
                                <tbody>
                                    <tr class="table-row">
                                        ...
                                        <td class="table-cell"><input type="password" name="password" required></td>
                                        <td class="table-cell"><input type="password" name="password2" required></td>
                                        <input type="hidden" name="role" value=$>
                                        <td class="table-cell">
                                            <button onclick="submit" class="submit-button">Đăng kí</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="pagination">
                        ...
                        <button class="action-button" onclick="window.location.href = 'listusers'">Quay lại danh sách tài khoản</button>
                    </div>
                </div>
            </div>
        </div>
