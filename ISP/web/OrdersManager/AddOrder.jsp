<%-- 
    Document   : AddOrder
    Created on : Mar 10, 2025, 12:48:12 AM
    Author     : ADMIN
--%>
        ...
        <form action="addorder" method="post" id="invoiceForm">
            <div class="invoice-details">
                ...
                <div class="input-container">
                    <label for="orderType">Loại Hóa Đơn:</label>
                    <select class="input-info" id="orderType" name="orderType" required>
                        <option value="1" selected>Nhập Hàng</option>
