...
<html lang="en">
    ...
    <body>
        ...
        <div class="homepage-body">
                    <div class="body-head">
                        <h3 class="body__head-title">Cập nhật tài khoản</h3>
                    </div>
                            ...
                            <table class="product-table">
                                ...
                                <thead>
                                    <tr class="table-header">
                                        <th class="table-header-item">Tên tài khoản</th>
                                        <th class="table-header-item">Mật khẩu</th>
                                        <th class="table-header-item">Nhập lại mật khẩu</th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-row">
                                        <td class="table-cell"><input type="text" id="username" name="username" value="<%= user.getUsername() %>" readonly></td>
                                        <td class="table-cell"><input type="password" id="password" name="password" value="<%= user.getPasswordHash() %> "required></td>
                                        <td class="table-cell"><input type="password" id="password2" name="password2" required></td>
                                        <td class="table-cell"><input type="text" id="fullname" name="fullname" value="<%= user.getFullName() %> " required></td>
                                <td class="table-cell">
